...
#lauch server
SGLANG_VLM_CACHE_SIZE_MB=256 python3 -m sglang.launch_server --model-path /data01/models/Qwen3.5-9B --host 127.0.0.1  --mem-fraction-static 0.7 --cuda-graph-max-bs 128 --tensor-parallel-size 2 --mm-attention-backend fa3 --cuda-graph-bs 64 56 48 40 32 24 16 8 4 2 1 --disable-radix-cache --context-length 262144 --reasoning-parser qwen3
#benchmark
