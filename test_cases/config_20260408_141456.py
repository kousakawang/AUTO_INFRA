...
config_dict = {
        "user_config": {
            ...
            "additional_option": [
                ['SGLANG_VLM_CACHE_SIZE_MB=0 --context-length 262144 --reasoning-parser qwen3'],
                [
                    "SGLANG_VLM_CACHE_SIZE_MB=256 --context-length 262144 --reasoning-parser qwen3",
                ],
                [
                    "SGLANG_VLM_CACHE_SIZE_MB=512 --context-length 262144 --reasoning-parser qwen3",
                ],
            ],
            "benchmark_case_num": [
                [1],
